...
function CustomerTable() {
  ...
  const saveChanges = () => {
    axios
      ...
      .then((response) => {
        const updatedCustomerList = listOfCustomers.map(
          (customer) =>
            customer.id === editedCustomer.id ? editedCustomer : customer //check wether current id and edit customer id maches
        );
